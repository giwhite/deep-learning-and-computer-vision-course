...
if __name__ == '__main__':
    ...
    trainset = datasets.CIFAR10('datasets', train=True, download=True, transform=transform)
    trainloader = DataLoader(trainset, batch_size=args.batch, num_workers=12, shuffle=True)
    testset = datasets.CIFAR10('datasets', train=False, download=True, transform=transform)
